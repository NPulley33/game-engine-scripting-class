...
namespace CharacterEditor
{
    public class MaterialManager : MonoBehaviour
    {
        ...
        private Material GetLeg(int id)
        {
            switch (id)
            {
                case 0: return m_Leg01;
                case 1: return m_Leg02;
                case 2: return m_Leg03;
        ...
        private Material GetHead(int id)
        {
            switch (id)
            {
                case 0: return m_Head01;
                case 1: return m_Head02;
                case 2: return m_Head03;
                default: return m_Head01;
            }
        }
        ...
        private Material GetBody(int id)
        {
            switch (id)
            {
                case 0: return m_Body01;
                case 1: return m_Body02;
                case 2: return m_Body03;
                default: return m_Body01;
            }
        }
    }
}